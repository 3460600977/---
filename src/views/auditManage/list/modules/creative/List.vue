        ...
        <el-tab-pane label="创意素材" name="material" class="material">
          <div class="top-screen"
            ...
            <div class="top-screen-box">
              <preview-top-box :innerWidth="108" :top="downloadCreative.data.topList.pre"
                               class="top-screen-pre"></preview-top-box>
        ...
        this.$api.AuditCreative.downloadAuditCreative(queryParam).then(res => {
          ...
          if (videoList.top != null && 0 in videoList.top) {
            ...
            this.downloadCreative.data.topList.pre = {
              type: this.$tools.getType(videoList.top[0].previewUrl).toLowerCase(),
