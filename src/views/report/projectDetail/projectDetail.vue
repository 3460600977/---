    ...
    <div class="detail-bottom-map">
      ...
      <div class="right-list">
        ...
        <div class="show_location_num">
                  ...
                  >
                    <template slot-scope="scope">
                      <div v-if="col.prop === 'status'">
                        <span
                          v-if="scope.row[scope.column.property].toString() === '1'"
          ...
          <PlanList v-if="playList.data.list" :mp4Data="playList.data" :showMp4="dialogPreviewVisible" :loading="playList.loading">
          </PlanList>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    showPreviewPlayList: async function(deviceCode) {
      ...
      let playList = await this.getProjectPlayList();
      this.playList.data.list = playList;
