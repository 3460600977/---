      ...
      <div class="echarts_content">
        ...
        <div class="line-echarts_change">
          <div>
            ...
            <el-checkbox v-model="selectLine.checked" class="compareCheck" @change="changeCompareValue">对比</el-checkbox>
            <el-select v-if="selectLine.checked"
                       placeholder="曝光数"
                       class="select_bar_line"
      ...
      <div class="news_case_list">
        <div class="news_case_item" @click="toPathNew(158)">
          ...
          <div class="news_case_content">
            ...
            <p>
              12月31日晚，2019年的最后一夜，罗振宇2019-2020“时间的朋友”跨年演讲在上海举行。今年跨年演讲的主题围绕着“基本盘”三个字展开，带着各位“时间的朋友”探索中国商业2020年的“基本盘”，厘清2020年的趋势和方向。新潮传媒作为联合特约合作伙伴，全程支持本次活动。</p>
          </div>
        </div>
        <div class="news_case_item" @click="toPathNew(156)">
          ...
          <div class="news_case_content">
            ...
            <p>
              12月26日，由四川省市场监管局指导、四川省广告协会主办的“2019四川广告人荣耀之夜”在成都举行。此次盛典集政府领导、高校教授、媒体、知名品牌等齐聚一堂，打造广告产业链条融合交流的高效平台，推动广告传媒行业的繁荣发展。</p>
          </div>
        </div>
        <div class="news_case_item" @click="toPathNew(157)">
          ...
          <div class="news_case_content">
            ...
            <p>
              12月25日，川商总会2020年新年演讲在成都举行。全国工商联副主席、四川省政协副主席、四川省工商联主席陈放，川商总会会长、新希望集团董事长刘永好，川商总会常务副会长、泸州老窖董事长刘淼等嘉宾齐聚盛典，聚焦商业前沿理念，探讨时代发展新趋势。</p>
          </div>
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      getSummaryDataChange: function () {
        ...
        this.$api.Login.GetSummaryData(param).then(res => {
