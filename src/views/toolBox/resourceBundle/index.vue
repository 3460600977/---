      ...
      <el-table :data="resultData" class="list_table">
        ...
        <el-table-column prop="premiseNum" label="楼盘数">
          <template slot-scope="scope">
            <span>{{scope.row.premiseNum | toThousands}}</span>
          </template>
        </el-table-column>
        <el-table-column prop="unitNum" label="单元数">
          <template slot-scope="scope">
            <span>{{scope.row.unitNum | toThousands}}</span>
          </template>
        </el-table-column>
        <el-table-column prop="deviceNum" label="点位数">
          <template slot-scope="scope">
            <span>{{scope.row.deviceNum | toThousands}}</span>
          </template>
        </el-table-column>
        <el-table-column prop="weekForPeople" label="覆盖人数">
          <template slot-scope="scope">
            <span>{{scope.row.weekForPeople | toThousands}}</span>
          </template>
        </el-table-column>
